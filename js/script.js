...
function createBox ( box, pos ) {
    ...
    // Followers 
    var baseHue = 320; // amarillo pastel
    var hueVariation = 30; // Más variación para diferentes tipos de amarillo
...
function drawGalaxy() {
    ...
    function animate() {
        ...
        for (var i = 0; i < stars.length; i++) {
            ...
            ctx.fillStyle = 'rgba(56, 7, 68, 1)';
            ctx.shadowColor = '#390966ff';
